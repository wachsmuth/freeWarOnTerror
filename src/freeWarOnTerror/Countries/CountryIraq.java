...
import static freeWarOnTerror.helpers.CardLookup.IRAQIWMD;
 ...
 * @author Emil
 */
public class CountryIraq extends MuslimCountry {

    public CountryIraq(CountryLookup c) {
        super(c);
    }
    ...
    public boolean canRegimeChange(){
        return isCardInPlay(IRAQIWMD) || super.canRegimeChange();
    }
}
